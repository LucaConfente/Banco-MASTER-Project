...
df = pd.read_csv('dado-Instituições-Individuais-ativo.csv', sep=';')
...
df_filtrado.to_csv('dados-tratados-banco-master-ativo.csv', sep=';', index=False, encoding='utf-8-sig')
print("✅ Arquivo salvo: dados-tratados-banco-master-ativo.csv")