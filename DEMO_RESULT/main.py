...
df = pd.read_csv('dados-Instituições-Individuais-DR.csv', sep=';')
...
df_filtrado.to_csv('dados-tratados-banco-master-DR.csv', sep=';', index=False, encoding='utf-8-sig')
print("✅ Arquivo salvo: dados-tratados-banco-master-DR.csv")